...
{{< include _c2-w1_alg-mc-prediction-any-visit.qmd >}}

::: {.callout-caution}
### Any visit / First-visit

The book uses presents a small variation called the *first visit MC method*. We considered the any-visit case. 
This estimates $v_\pi(s)$ using the average of the returns following an episode's first visit to $s$, whereas this the every-visit MC algorithms averages the returns following all visits to $s$
:::

{{< include _c2-w1_alg-mc-prediction-first-visit.qmd >}}
...
{{< include _c2-w1_alg-mc-es-control.qmd >}}
...
{{< include _c2-w1_alg-mc-ϵ-soft-control.qmd >}}
...
\begin{aligned}
  ...
  & = \pi(A_t \mid S_t)p(S_{t+1} \mid S_t, A_t)\pi(A_{t+1}, S_{t+1}) \cdot\cdot\cdot p(S_T \mid S_{T-1}, A_{T-1}) \\ 
...
{{< include _c2-w1_alg-off-policy-mc-predictions.qmd >}}


{{< include _c2-w1_alg-mc-off-control-prediction.qmd >}}
